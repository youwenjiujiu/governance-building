...
CREATE TABLE buildings (
    ...
    gross_floor_area    DOUBLE PRECISION NOT NULL,
...
CREATE TABLE points (
    ...
    cov_enabled             BOOLEAN,
    cov_increment           DOUBLE PRECISION,
    min_value               DOUBLE PRECISION,
    max_value               DOUBLE PRECISION,
    default_value           VARCHAR(50),
    -- 告警相关
    alarm_enabled           BOOLEAN NOT NULL DEFAULT false,
    alarm_hi_hi             DOUBLE PRECISION,
    alarm_hi                DOUBLE PRECISION,
    alarm_lo                DOUBLE PRECISION,
    alarm_lo_lo             DOUBLE PRECISION,
    alarm_deadband          DOUBLE PRECISION,
    alarm_delay_s           INT,
    -- 趋势记录相关
